...
\item
  \textbf{Curve DAO}\\
  April 2022 - current, \emph{Researcher}

  \begin{itemize}
  \tightlist
  \item
    Optimize pool parameters for increased fee revenue and better risk
    levels.
  \item
    Build out services and tools to help the DAO and participating
    protocols assess pool performance and risks.
  \item
    Identify risks to Curve stakeholders for gauge emissions voting.
  \end{itemize}
\item
  \textbf{APY Finance}\\
